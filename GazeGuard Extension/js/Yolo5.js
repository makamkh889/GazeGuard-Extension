function segYolov5Type(imgIMG)
    ...
    const mask_img = new ImageData(new Uint8ClampedArray(overlay.data),overlay.cols,overlay.rows);
    ...
    function runInference() {
       ...
       // console.log("oldsrc",imgIMG.oldsrc);
       if(imgIMG.tagName!="IMG" && imgIMG.tagName!="VIDEO"){
