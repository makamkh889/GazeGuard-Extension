...
function DoWin(win, winContentLoaded) {
    //console.log("Model_Type_____",Model_Type);
    ...
    function DoElement() {
        ...
        if (this.tagName == 'IMG') {
            ...
            if (this.classList.contains("blankImg")) { //was successfully replaced
                DoHidden(this, false);
               ...
               // console.log("aft",this);
                ...
                else if(this.classList.contains("initial"))
                {
                   if(Model_Type==5)
                   {
                        segYolov5Type(this);
           ...
           DoWizmageBG(this, true);
            ...
            else if(bgimg != 'none' && (width == 0 || width >= 32) && (height == 0 || height >= 32) && bgimg.slice(0, 3)== 'url')
            {
                // AddToList(this);
                DoMouseEventListeners(this, true);
                DoHidden(this, true);
                let quit=this.oldsrc;
                this.oldsrc = bgimg;
                if(this.classList.contains("Origin"))
                {
                    this.style.backgroundImage =quit;
                    this.classList.remove("Origin");
                }
                else 
                {
                    
                    this.style.backgroundImage = 'url("' + test + '")';
                       this.src=test;
                       if(Model_Type==5)
                       {
                            segYolov5Type(this);
                ...
                console.log("ORIGIN",this.oldsrc);
    ...
    function DoHoverVisualClearTimer(el, toggle) {
        if (toggle) {
            DoHoverVisualClearTimer(el, false);
            el.wzmClearHoverVisualTimer = setTimeout(function () { DoHoverVisual(el, false); }, 22500);
        }
    ...
    function ShowEl() {
        ...
        if (this.tagName == 'IMG') {
            ...
            this.classList.remove("blankImg");
            ...
            var compStyle = getComputedStyle(this), bgimg = compStyle['background-image'];
            console.log("show");
            this.classList.add("Origin");
            this.classList.remove("blankImg");
            DoLoadEventListener(this, false);
